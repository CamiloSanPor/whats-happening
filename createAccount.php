<?php
  ...
  */
  function checkUsername(){
    ...
    // stores row returned
    $checkUsername = $result->fetch_assoc();

    // true if username exists, false if it doesn't
    return isset($checkUsername);
  }

  /*
    inserts submitted group data into the database 
  */
  function insertGroup(){
    ...
    $insert = "
    INSERT INTO groups
        (GroupName, GroupImage, GroupType, GroupDesc, ContactName, ContactEmail) 
    VALUES
        (?, ?, ?, ?, ?, ?)
    ";
    ...
    $GroupImage = "files/images/Groups/$_POST[groupImage]";
    ...
    $statement = $mysqli->prepare($insert);
    // parameters are bound
    $statement->bind_param("iss", $GroupID, $username, $password);
  ...
  */
  ...
  if (isset($_POST['submit'])){
    ...
    $repeatUsername = checkUsername();

    // if username is unique, inserts group and starts session
    if (!$repeatUsername){
      insertGroup();
      startSession();
    }
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="form mt-5 mx-5">
          ...
          <form action="" method="post" role="form" class="php-email-form">
            ...
            <div class="form-group">
              <input type="text" class="form-control" name="groupType" id="groupType" placeholder="What type of group are you?" required>
            </div>
            ...
            <div class="form-group">
              <textarea class="form-control" name="description" rows="3" placeholder="Tell us about your group" required></textarea>
            </div>
            ...
            <div class="text-center">
              <input class="btn btn-success btn-lg" type="submit" name="submit"></input>
            </div>
            ...
            <?php
              ...
              if (isset($_POST['submit'])){
                ...
                if ($repeatUsername){
                  echo "<p class='text-center mt-3 mb-0'>Username already exists, please try again</p>";
                }
